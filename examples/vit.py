# from: https://github.com/jeonsworld/ViT-pytorch/blob/main/models/modeling.py
...
def get_ti8_config():
    """Returns the ViT-Ti/8 configuration."""
...
ViT_CONFIGS = {
    'vit-t8': get_ti8_config(),
    'vit-s8': get_s8_config(),
    'vit-b16': get_b16_config(),
    'vit-b32': get_b32_config(),
    'vit-l16': get_l16_config(),
    'vit-l32': get_l32_config(),
}

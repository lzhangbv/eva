...
#epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=0.1 nworkers=4 kfac_name=$eva kfac=1 fac=1 damping=0.03 stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=5 lr_schedule=polynomial momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=10 ./train_cifar10.sh &
...
#topk=512 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=0.1 nworkers=4 kfac_name=semi-kfac kfac=50 fac=50 damping=0.03 stat_decay=1 kl_clip=0.001 warmup_epochs=5 lr_schedule=step momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=16 ./train_cifar10.sh &

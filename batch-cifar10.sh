...
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=0 fac=0 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=1 ./train_cifar10.sh &
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=1 fac=1 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=2 ./train_cifar10.sh &
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=kfac kfac=10 fac=10 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=3 ./train_cifar10.sh &
seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=0 fac=0 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=4 ./train_cifar10.sh &
seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=1 fac=1 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=5 ./train_cifar10.sh &
seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=kfac kfac=10 fac=10 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=6 ./train_cifar10.sh &
seed=3 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=0 fac=0 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=7 ./train_cifar10.sh &
seed=3 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=1 fac=1 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=8 ./train_cifar10.sh &
seed=3 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=kfac kfac=10 fac=10 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=9 ./train_cifar10.sh &
...
lr=0.001
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=0 fac=0 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=14 ./train_cifar10.sh &
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=1 fac=1 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=15 ./train_cifar10.sh &
seed=1 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=kfac kfac=10 fac=10 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=16 ./train_cifar10.sh &

seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=0 fac=0 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=10 ./train_cifar10.sh &
seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=eva kfac=1 fac=1 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=11 ./train_cifar10.sh &
seed=2 epochs=$epochs dnn=$dnn dataset=$dataset batch_size=$bs base_lr=$lr weight_decay=$weight_decay use_pretrained_model=1 warmup_epochs=0 lr_decay=$lr_decay nworkers=4 kfac_name=kfac kfac=10 fac=10 damping=$damping stat_decay=$stat_decay kl_clip=$kl_clip warmup_epochs=0 lr_schedule=$lr_schedule momentum=0.9 label_smoothing=0 cutmix=0 autoaugment=0 cutout=0 horovod=0 node_rank=12 ./train_cifar10.sh &

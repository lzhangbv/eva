...
#opt_name=sgd epochs=100 dnn=autoencoder dataset=mnist batch_size=1000 base_lr=0.6 kfac_name=eva kfac=0 fac=0 damping=0.03 stat_decay=0.95 kl_clip=-1 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=sgd epochs=100 dnn=autoencoder dataset=mnist batch_size=1000 base_lr=0.018 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=-1 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh

...
dnn=wrn28-10
dataset=cifar10
#epochs=100 dnn=$dnn dataset=$dataset batch_size=128 base_lr=0.1 nworkers=4 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=5 lr_schedule=step momentum=0.9 cutmix=1 autoaugment=1 horovod=0 node_rank=1  ./train_cifar10.sh &
#epochs=100 dnn=$dnn dataset=$dataset batch_size=128 base_lr=0.1 nworkers=4 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=5 lr_schedule=step momentum=0 cutmix=1 autoaugment=1 horovod=0 node_rank=2  ./train_cifar10.sh &
#epochs=100 dnn=$dnn dataset=$dataset batch_size=128 base_lr=0.1 nworkers=4 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=-1 warmup_epochs=5 lr_schedule=step momentum=0.9 cutmix=1 autoaugment=1 horovod=0 node_rank=3 ./train_cifar10.sh &
#epochs=100 dnn=$dnn dataset=$dataset batch_size=128 base_lr=0.1 nworkers=4 kfac_name=adasgd kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=5 lr_schedule=step momentum=0.9 cutmix=1 autoaugment=1 horovod=0 node_rank=4 ./train_cifar10.sh &


# (6) autoencoder on mnist, fmnist, faces, curves
dataset=mnist # mnist, fmnist, faces, curves
#opt_name=sgd epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.6 kfac_name=eva kfac=0 fac=0 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=adamw weight_decay=0.05 epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.005 kfac_name=eva kfac=0 fac=0 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=sgd epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.06 kfac_name=kfac kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=sgd epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.06 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=shampoo epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.06 kfac_name=eva kfac=10 fac=10 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=adagrad epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.006 kfac_name=eva kfac=0 fac=0 damping=0.03 stat_decay=0.95 kl_clip=0.001 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh

#dataset=mnist
#opt_name=sgd epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.6 kfac_name=eva kfac=0 fac=0 damping=0.03 stat_decay=0.95 kl_clip=-1 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
#opt_name=sgd epochs=100 dnn=autoencoder dataset=$dataset batch_size=1000 base_lr=0.018 kfac_name=eva kfac=1 fac=1 damping=0.03 stat_decay=0.95 kl_clip=-1 warmup_epochs=0 lr_schedule=linear momentum=0.9 horovod=0 node_rank=8 ./train_mnist.sh
